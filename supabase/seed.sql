...
('Maa Sheetal Caterers', 'Caterer', 'Jaipur', false, 'Concierge',
 ...
 'Home-style Rajasthani and Punjabi catering. Family-run kitchen. VowVoyage agent assists with digital bookings on their behalf.',
...
('Suresh Wedding Clicks', 'Photographer', 'Jaipur', false, 'Concierge',
 ...
 'Local photographer with 12 years experience. Covers religious ceremonies with sensitivity. VowVoyage agent handles all inquiries.',
...
(NULL, NULL,
 'Just booked Shekhawati Decorators for our Jaipur palace wedding! The floral installation mock-up they sent is absolutely breathtaking. Loving the VowVoyage experience — all the vendors are clearly verified and professional.',
 'https://picsum.photos/seed/post1/600/400',
 ARRAY['jaipur','decor','palace-wedding']),

(NULL, NULL,
 'NRI couple here — planning our destination wedding from Toronto to Udaipur. VowVoyage has been a lifesaver! Found Palace Blooms and Lake City Shutters through the platform. The pandit speaks English too which is such a relief.',
...
(NULL, NULL,
 'Maa Sheetal Caterers in Jaipur were AMAZING. The VowVoyage agent helped us communicate with them since they don''t use apps much. The food was unbelievably authentic — guests are still talking about the dal baati churma!',
 'https://picsum.photos/seed/post4/600/400',
 ARRAY['caterer','jaipur','agent-managed','authentic']),

(NULL, NULL,
 'Goa beach wedding goals achieved! Coastal Blooms set up the most stunning driftwood arch and the DJ Tropics kept the dance floor going till sunrise. Highly recommend VowVoyage for destination weddings.',
 'https://picsum.photos/seed/post5/600/400',
 ARRAY['goa','beach-wedding','dj','decor']),

(NULL, NULL,
 'Quick reminder: VowVoyage does NOT share your phone number or personal details with vendors until the deal is confirmed. I felt so much safer booking through here vs direct WhatsApp approach. Total peace of mind.',
 'https://picsum.photos/seed/post6/600/400',
 ARRAY['privacy','safety','tip']),

(NULL, NULL,
 'Our VowVoyage Event Team feature post-booking was INCREDIBLE. The photographer, decorator and caterer had a group call coordinated by VowVoyage — no confusion on the day at all. Every vendor knew exactly where to be.',
 'https://picsum.photos/seed/post7/600/400',
 ARRAY['event-team','coordination','tip','success']),

(NULL, NULL,
 'Mehendi Magic by Priya in Delhi is worth every rupee. Her team of 4 artists did the full family in 3 hours! She''s on VowVoyage Premium so you can trust the quality. Already referred her to 3 friends.',
 'https://picsum.photos/seed/post8/600/400',
 ARRAY['delhi','mehendi','premium','referral']),

(NULL, NULL,
 'Planning an intercultural wedding (Hindu + Christian) in Mumbai. Found Vedic Vivah Pundit through VowVoyage — he''s done dozens of interfaith ceremonies and put us completely at ease. Platform makes finding niche vendors so easy.',
 'https://picsum.photos/seed/post9/600/400',
 ARRAY['interfaith','mumbai','pandit','intercultural']),

(NULL, NULL,
 'The VowVoyage Concierge plan is perfect for vendors like my Uncle who has been doing dhol for 25 years but doesn''t use smartphones. The VowVoyage advisor listed him and now he gets bookings through the platform without any confusion!',
...
(NULL, NULL,
 'Hyderabad wedding inspo: Falaknuma-style banquet + Golconda Decors pearl motif setup + Dum Biryani Caterers authentic haleem. Found all three through VowVoyage in one afternoon. The search filters are genuinely useful.',
 'https://picsum.photos/seed/post12/600/400',
 ARRAY['hyderabad','venue','decor','biryani']),

(NULL, NULL,
 'For Bengaluru couples — Lalbagh Garden Weddings is stunning for an outdoor ceremony. The pergola is Instagram gold. Used VowVoyage''s city filter to shortlist Bengaluru venues in minutes. Highly recommend the platform.',
 'https://picsum.photos/seed/post13/600/400',
 ARRAY['bengaluru','venue','outdoor','garden']),

(NULL, NULL,
 'VowVoyage reminder: the 2% commission keeps this platform alive and pays for the verification, privacy protection and Event Team coordination. Always complete deals through VowVoyage — it protects YOU as a couple too.',
 'https://picsum.photos/seed/post14/600/400',
 ARRAY['platform','commission','tip','transparency']),

(NULL, NULL,
 'Just had our sangeet in Chandigarh — Bass Culture DJ had the whole crowd going crazy with the bhangra set. Used VowVoyage basket to compare 3 DJs before picking them. Best decision ever. Our parents were dancing!',
