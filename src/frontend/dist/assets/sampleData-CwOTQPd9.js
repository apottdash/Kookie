import { r as reactExports, j as jsxRuntimeExports, C as Category, g as ContentLanguage, G as Genre } from "./index-hVcvNcQS.js";
...
const sampleLinks = [
  // BTS Live
  {
    ...
    description: "Full concert performance of BTS in Busan — one for the history books, ARMY! 💜",
    ...
    addedAt: BigInt(1697e6),
    addedBy: { toText: () => "aaaaa-bbbbb", isAnonymous: () => false }
  },
  {
    id: BigInt(2),
    title: "BTS Permission to Dance On Stage — Seoul",
    description: "Epic live concert with all 7 members performing their greatest hits! 🎤",
  ...
  },
  {
    ...
    description: "Virtual concert experience — feel the stage energy from home! 🌟",
  ...
  // K-Dramas
  {
    ...
    description: "A North Korean military officer falls in love with a South Korean heiress — a must-watch! 🪂",
  ...
  },
  {
    ...
    description: "An immortal goblin seeks his human bride to end his cursed life. Visually stunning! ✨",
  ...
  },
  {
    ...
    description: "A heartwarming youth romance set in the late 90s. Pure nostalgia and tears 🥹",
  ...
  // Manhwas — with language tags
  {
    id: BigInt(7),
    title: "Solo Leveling",
    description: "The world's weakest hunter becomes the strongest after a mysterious quest. Incredible power-up arc! ⚔️",
  ...
  },
  {
    id: BigInt(8),
    title: "True Beauty",
    description: "A girl transforms herself with makeup mastery and finds love. BTS member appearance inside! 💄",
  ...
  },
  {
    ...
    description: "A king reincarnated into a world of magic — epic fantasy manhwa with deep lore 🔮",
  ...
  },
  {
    id: BigInt(10),
    title: "Tower of God",
    description: "Twenty-Fifth Bam enters a mysterious tower to find his only friend Rachel. Epic world-building and battles! 🗼",
  ...
  },
  {
    ...
    description: "A man who read the world's most obscure web novel suddenly finds himself living inside it. Mind-bending story! 📖",
    ...
    addedAt: BigInt(1697001e3),
    addedBy: { toText: () => "aaaaa-bbbbb", isAnonymous: () => false }
  },
  {
    id: BigInt(12),
    title: "La Reine Réincarnée (The Remarried Empress — FR)",
    description: "Une impératrice brillante trahie reconstruit sa vie avec un nouvel empire. Art somptueux 👑",
  ...
  },
  {
    ...
    description: "एक टॉप सर्जन राजकुमारी के रूप में पुनर्जन्म लेती है और आधुनिक चिकित्सा का उपयोग करती है 🏥",
  ...
  },
  {
    ...
    description: "A girl cursed to turn into a dog at night must break the spell by getting her first kiss again 🐶",
  ...
  },
  {
    id: BigInt(15),
    title: "Noblesse",
    description: "A noble vampire awakens after 820 years and navigates modern society with his loyal servant 🧛",
  ...
  },
  {
    ...
    description: "En un mundo donde todos tienen superpoderes, John finge ser ordinario — pero esconde un secreto devastador ⚡",
  ...
  },
  {
    ...
    description: "Una diseñadora de videojuegos introvertida lidia con su vecino famoso streamer que reseñó negativamente su juego 🎮",
  ...
  // BTS Songs
  {
    id: BigInt(18),
    title: "Dynamite — BTS",
    description: "BTS's first all-English hit — a feel-good retro disco-pop anthem that took the world by storm! 💥",
    ...
    addedAt: BigInt(1697002e3),
    addedBy: { toText: () => "aaaaa-bbbbb", isAnonymous: () => false }
  },
  {
    id: BigInt(19),
    title: "Butter — BTS",
    description: "Smooth like butter — this silky pop track is summer in song form. Certified ARMY bop! 🧈",
  ...
  },
  {
    ...
    description: "The rap line delivers their most iconic cypher yet — RM, Suga, and J-Hope go OFF 🔥",
  ...
  },
  {
    ...
    description: "A heartbreaking ballad about longing and reunion. One of BTS's most beloved songs of all time 🌸",
  ...
  },
  {
    ...
    description: "BTS x Steve Aoki collide in this electrifying EDM remix. The beat drop hits different! ⚡",
  ...
  // Fan Fiction
  {
    ...
    description: "A breathtaking romance AU where you meet Taehyung at a Seoul art gallery. Over 2M reads on Wattpad! 💜",
    ...
    addedAt: BigInt(1697003e3),
    addedBy: { toText: () => "aaaaa-bbbbb", isAnonymous: () => false }
  },
  {
    id: BigInt(24),
    title: "Seven Stars: BTS Supernatural AU",
    description: "What if BTS members had supernatural powers? Epic AU with emotional depth and incredible world-building 🌙",
  ...
  },
  {
    ...
    description: "A fan-made drama series inspired by BTS's 'Run' era. Incredible cinematography and storyline 🎬",
  ...
  },
  {
    ...
    description: "You work at a late-night café, he's a brooding musician who only comes in after midnight. Pure Yoongi energy ☕",
  ...
  },
  {
    ...
    description: "All 7 members at university dealing with music, friendship, and first love. A classic ARMY fan fic! 🎓",
...
const samplePosts = [
  {
    id: BigInt(1),
    content: "Just watched BTS Permission to Dance concert for the 5th time and I'm still crying every single time. The way Jimin dances is just... unmatched 💜 ARMY forever!",
    hashtags: ["BTS", "PermissionToDance", "Jimin", "ARMY"],
    createdAt: BigInt(169705e4),
    author: {
  ...
  {
    id: BigInt(2),
    content: "Anyone else reading Solo Leveling? Just finished chapter 150 and I need to talk about it RIGHT NOW. Sung Jinwoo's glow-up is everything ⚔️",
    hashtags: ["SoloLeveling", "Manhwa", "Webtoon"],
    createdAt: BigInt(169704e4),
    author: {
  ...
  {
    id: BigInt(3),
    content: "Crash Landing on You had me sobbing for 3 hours straight. Hyun Bin and Son Ye-jin are LEGENDS. If you haven't watched it yet, what are you doing?! 🪂💕",
    hashtags: ["CrashLandingOnYou", "KDrama", "HyunBin"],
    createdAt: BigInt(169703e4),
    author: {
  ...
  {
    id: BigInt(4),
    content: "Purple hour ✨ Counting down the days until BTS reunites post-military service. The comeback will shake the entire world. Believe in us, believe in them 💜",
    hashtags: ["BTS", "ComingSoon", "ARMY", "PurpleYou"],
    createdAt: BigInt(169702e4),
    author: {
  ...
  {
    id: BigInt(5),
    content: "True Beauty manhwa just updated and I CANNOT handle the Suho moment we waited 200 chapters for! Reading this at 2am was a mistake 😭💜",
    hashtags: ["TrueBeauty", "Manhwa", "Suho"],
    createdAt: BigInt(169701e4),
    author: {
