// VendorBasketPage — repurposed from WatchlistPage for VowVoyage
              ...
              <Card className="border-border bg-card sticky top-24 shadow-elevated">
                <CardContent className="p-5 flex flex-col gap-4">
                  ...
                  <div className="bg-muted/30 rounded-xl p-3 text-xs text-muted-foreground leading-relaxed">
                    ...
                    deal is confirmed through VowVoyage.
                  </div>
                  ...
                  <div className="bg-accent/5 border border-accent/20 rounded-xl p-3 text-xs leading-relaxed flex items-start gap-2">
                    ...
                    <span className="text-muted-foreground">
                      ...
                      once all deals are confirmed, VowVoyage can introduce your
