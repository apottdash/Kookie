// VendorOnboardingPage — real vendor registration for WedVow
...
const PLANS = [
  ...
  },
  {
    ...
    features: ["WedVow advisor manages your listing", "1% commission", "No smartphone needed", "Advisor handles inquiries for you"],
  },
];
...
export default function VendorOnboardingPage() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      toast.error("Something went wrong. Please try again or contact WedVow support.");
      console.error(err);
    } finally {
      setSubmitting(false);
    }
      ...
      <div className="pb-20 md:pb-0">
        <div className="container mx-auto px-4 py-20 flex flex-col items-center text-center gap-6 max-w-md">
          ...
          <p className="text-muted-foreground leading-relaxed">
            Your listing has been submitted. The WedVow team will review and
          ...
          <div className="bg-primary/5 rounded-xl p-4 text-sm text-muted-foreground text-left w-full space-y-2">
            ...
            <p>✅ WedVow team reviews your listing</p>
            ...
            <Card className="border-border bg-card">
              <CardContent className="p-6 flex flex-col gap-5">
                ...
                <div className="flex flex-col gap-1.5">
                  ...
                  />
                  <p className="text-xs text-muted-foreground">
                    Only shared with couples after deal is confirmed through WedVow
                  </p>
                </div>
              ...
              <Card className="border-border bg-card">
                <CardContent className="p-6 flex flex-col gap-4">
                  ...
                  <p className="text-sm text-muted-foreground">
                    You can upgrade anytime. Start with Free and see how WedVow works for you.
                  </p>
              ...
              <Card className="border-border bg-card">
                <CardContent className="p-5 flex flex-col gap-3">
                  <div className="flex items-start gap-2 text-xs text-muted-foreground bg-muted/30 rounded-xl p-3">
                    ...
                    <span>
                      <strong className="text-foreground">WedVow T&C:</strong>{" "}
                      Your contact details are never shared with couples until a deal is confirmed. A{" "}
                      <strong className="text-foreground">2% commission</strong> is due on all bookings originated through WedVow, including those settled outside the platform. Bypassing WedVow after an introduction may result in legal action.
                    </span>
                  </div>
                  ...
                  <label className="flex items-start gap-2 text-sm text-muted-foreground cursor-pointer">
                    ...
                    />
                    <span>
                      I agree to the WedVow Terms & Conditions, including the commission and contact-release policy.
                    </span>
                  </label>
