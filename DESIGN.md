...
| Role | Light | Dark |
| --- | --- | --- |
| Primary (VowVoyage Purple) | L 0.48 C 0.22 H 290 | L 0.70 C 0.25 H 290 |
...
| `Header` | VowVoyage logo, search, basket icon with count, auth |
...
| Zone | Treatment |
| --- | --- |
| Header | Sticky, bg-card with border-b; VowVoyage logo (W icon + wordmark); search; basket count badge; auth |
