...
VowVoyage uses Supabase (PostgreSQL) for vendor listings, basket items, inquiries, and bookings.
...
| Concierge | Dedicated VowVoyage advisor manages the listing — for vendors who prefer hands-off onboarding |
